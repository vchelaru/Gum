...
partial class Keyboard : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    protected virtual void InitializeInstances()
    {
        ...
        Key1 = new KeyboardKey();
        Key1.Name = "Key1";
        KeyQ = new KeyboardKey();
        KeyQ.Name = "KeyQ";
        KeyA = new KeyboardKey();
        KeyA.Name = "KeyA";
        KeyZ = new KeyboardKey();
        KeyZ.Name = "KeyZ";
        KeyParenLeft = new KeyboardKey();
        KeyParenLeft.Name = "KeyParenLeft";
        KeyW = new KeyboardKey();
        KeyW.Name = "KeyW";
        KeyS = new KeyboardKey();
        KeyS.Name = "KeyS";
        KeyX = new KeyboardKey();
        KeyX.Name = "KeyX";
        KeyParenRight = new KeyboardKey();
        KeyParenRight.Name = "KeyParenRight";
        KeyE = new KeyboardKey();
        KeyE.Name = "KeyE";
        KeyD = new KeyboardKey();
        KeyD.Name = "KeyD";
        KeyC = new KeyboardKey();
        KeyC.Name = "KeyC";
        KeySpace = new KeyboardKey();
        KeySpace.Name = "KeySpace";
        KeyR = new KeyboardKey();
        KeyR.Name = "KeyR";
        KeyF = new KeyboardKey();
        KeyF.Name = "KeyF";
        KeyV = new KeyboardKey();
        KeyV.Name = "KeyV";
        KeyT = new KeyboardKey();
        KeyT.Name = "KeyT";
        KeyG = new KeyboardKey();
        KeyG.Name = "KeyG";
        KeyB = new KeyboardKey();
        KeyB.Name = "KeyB";
        KeyY = new KeyboardKey();
        KeyY.Name = "KeyY";
        KeyH = new KeyboardKey();
        KeyH.Name = "KeyH";
        KeyN = new KeyboardKey();
        KeyN.Name = "KeyN";
        KeyU = new KeyboardKey();
        KeyU.Name = "KeyU";
        KeyJ = new KeyboardKey();
        KeyJ.Name = "KeyJ";
        KeyM = new KeyboardKey();
        KeyM.Name = "KeyM";
        KeyI = new KeyboardKey();
        KeyI.Name = "KeyI";
        KeyK = new KeyboardKey();
        KeyK.Name = "KeyK";
        KeyComma = new KeyboardKey();
        KeyComma.Name = "KeyComma";
        KeyQuestion = new KeyboardKey();
        KeyQuestion.Name = "KeyQuestion";
        KeyO = new KeyboardKey();
        KeyO.Name = "KeyO";
        KeyL = new KeyboardKey();
        KeyL.Name = "KeyL";
        KeyPeriod = new KeyboardKey();
        KeyPeriod.Name = "KeyPeriod";
        KeyBang = new KeyboardKey();
        KeyBang.Name = "KeyBang";
        KeyP = new KeyboardKey();
        KeyP.Name = "KeyP";
        KeyUnderscore = new KeyboardKey();
        KeyUnderscore.Name = "KeyUnderscore";
        KeyHyphen = new KeyboardKey();
        KeyHyphen.Name = "KeyHyphen";
        KeyAmpersand = new KeyboardKey();
        KeyAmpersand.Name = "KeyAmpersand";
        Key2 = new KeyboardKey();
        Key2.Name = "Key2";
        Key3 = new KeyboardKey();
        Key3.Name = "Key3";
        Key4 = new KeyboardKey();
        Key4.Name = "Key4";
        Key5 = new KeyboardKey();
        Key5.Name = "Key5";
        Key6 = new KeyboardKey();
        Key6.Name = "Key6";
        Key7 = new KeyboardKey();
        Key7.Name = "Key7";
        Key8 = new KeyboardKey();
        Key8.Name = "Key8";
        Key9 = new KeyboardKey();
        Key9.Name = "Key9";
        Key0 = new KeyboardKey();
        Key0.Name = "Key0";
        ...
        KeyBackspace = new KeyboardKey();
        KeyBackspace.Name = "KeyBackspace";
        KeyReturn = new KeyboardKey();
        KeyReturn.Name = "KeyReturn";
        KeyLeft = new KeyboardKey();
        KeyLeft.Name = "KeyLeft";
        KeyRight = new KeyboardKey();
        ...
        IconInstance2 = new Icon();
        IconInstance2.Name = "IconInstance2";
        IconInstance3 = new Icon();
