...
partial class Keyboard : global::Gum.Forms.Controls.FrameworkElement
{
    ...
    protected virtual void AssignParents()
    {
        ...
        Row1Keys.AddChild(Key1.Visual);
        Row2Keys.AddChild(KeyQ.Visual);
        Row3Keys.AddChild(KeyA.Visual);
        Row4Keys.AddChild(KeyZ.Visual);
        Row5Keys.AddChild(KeyParenLeft.Visual);
        Row2Keys.AddChild(KeyW.Visual);
        Row3Keys.AddChild(KeyS.Visual);
        Row4Keys.AddChild(KeyX.Visual);
        Row5Keys.AddChild(KeyParenRight.Visual);
        Row2Keys.AddChild(KeyE.Visual);
        Row3Keys.AddChild(KeyD.Visual);
        Row4Keys.AddChild(KeyC.Visual);
        Row5Keys.AddChild(KeySpace.Visual);
        Row2Keys.AddChild(KeyR.Visual);
        Row3Keys.AddChild(KeyF.Visual);
        Row4Keys.AddChild(KeyV.Visual);
        Row2Keys.AddChild(KeyT.Visual);
        Row3Keys.AddChild(KeyG.Visual);
        Row4Keys.AddChild(KeyB.Visual);
        Row2Keys.AddChild(KeyY.Visual);
        Row3Keys.AddChild(KeyH.Visual);
        Row4Keys.AddChild(KeyN.Visual);
        Row2Keys.AddChild(KeyU.Visual);
        Row3Keys.AddChild(KeyJ.Visual);
        Row4Keys.AddChild(KeyM.Visual);
        Row2Keys.AddChild(KeyI.Visual);
        Row3Keys.AddChild(KeyK.Visual);
        Row4Keys.AddChild(KeyComma.Visual);
        Row5Keys.AddChild(KeyQuestion.Visual);
        Row2Keys.AddChild(KeyO.Visual);
        Row3Keys.AddChild(KeyL.Visual);
        Row4Keys.AddChild(KeyPeriod.Visual);
        Row5Keys.AddChild(KeyBang.Visual);
        Row2Keys.AddChild(KeyP.Visual);
        Row3Keys.AddChild(KeyUnderscore.Visual);
        Row4Keys.AddChild(KeyHyphen.Visual);
        Row5Keys.AddChild(KeyAmpersand.Visual);
        Row1Keys.AddChild(Key2.Visual);
        Row1Keys.AddChild(Key3.Visual);
        Row1Keys.AddChild(Key4.Visual);
        Row1Keys.AddChild(Key5.Visual);
        Row1Keys.AddChild(Key6.Visual);
        Row1Keys.AddChild(Key7.Visual);
        Row1Keys.AddChild(Key8.Visual);
        Row1Keys.AddChild(Key9.Visual);
        Row1Keys.AddChild(Key0.Visual);
