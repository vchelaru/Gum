...
partial class DemoScreenGumRuntime : Gum.Wireframe.BindableGue
{
    ...
    public override void AfterFullCreation()
    {
        ...
        ButtonCloseInstance1 = this.GetGraphicalUiElementByName("ButtonCloseInstance1") as CodeGen_MonoGame_ByReference.Components.Controls.ButtonCloseRuntime;
        DividerInstance = this.GetGraphicalUiElementByName("DividerInstance") as CodeGen_MonoGame_ByReference.Components.Elements.DividerHorizontalRuntime;
        DividerInstance4 = this.GetGraphicalUiElementByName("DividerInstance4") as CodeGen_MonoGame_ByReference.Components.Elements.DividerHorizontalRuntime;
        ResolutionLabel = this.GetGraphicalUiElementByName("ResolutionLabel") as CodeGen_MonoGame_ByReference.Components.Controls.LabelRuntime;
        ResolutionBox = this.GetGraphicalUiElementByName("ResolutionBox") as CodeGen_MonoGame_ByReference.Components.Controls.ListBoxRuntime;
        DetectResolutionsButton = this.GetGraphicalUiElementByName("DetectResolutionsButton") as CodeGen_MonoGame_ByReference.Components.Controls.ButtonStandardRuntime;
        ShowDialogButton = this.GetGraphicalUiElementByName("ShowDialogButton") as CodeGen_MonoGame_ByReference.Components.Controls.ButtonStandardRuntime;
        ShowToastButton = this.GetGraphicalUiElementByName("ShowToastButton") as CodeGen_MonoGame_ByReference.Components.Controls.ButtonStandardRuntime;
        FullScreenCheckbox = this.GetGraphicalUiElementByName("FullScreenCheckbox") as CodeGen_MonoGame_ByReference.Components.Controls.CheckBoxRuntime;
        DividerInstance1 = this.GetGraphicalUiElementByName("DividerInstance1") as CodeGen_MonoGame_ByReference.Components.Elements.DividerHorizontalRuntime;
        MusicLabel = this.GetGraphicalUiElementByName("MusicLabel") as CodeGen_MonoGame_ByReference.Components.Controls.LabelRuntime;
        MusicSlider = this.GetGraphicalUiElementByName("MusicSlider") as CodeGen_MonoGame_ByReference.Components.Controls.SliderRuntime;
        SoundLabel = this.GetGraphicalUiElementByName("SoundLabel") as CodeGen_MonoGame_ByReference.Components.Controls.LabelRuntime;
        SoundSlider = this.GetGraphicalUiElementByName("SoundSlider") as CodeGen_MonoGame_ByReference.Components.Controls.SliderRuntime;
        DividerInstance2 = this.GetGraphicalUiElementByName("DividerInstance2") as CodeGen_MonoGame_ByReference.Components.Elements.DividerHorizontalRuntime;
        ControlLabel = this.GetGraphicalUiElementByName("ControlLabel") as CodeGen_MonoGame_ByReference.Components.Controls.LabelRuntime;
        RadioButtonInstance = this.GetGraphicalUiElementByName("RadioButtonInstance") as CodeGen_MonoGame_ByReference.Components.Controls.RadioButtonRuntime;
        RadioButtonInstance1 = this.GetGraphicalUiElementByName("RadioButtonInstance1") as CodeGen_MonoGame_ByReference.Components.Controls.RadioButtonRuntime;
        RadioButtonInstance2 = this.GetGraphicalUiElementByName("RadioButtonInstance2") as CodeGen_MonoGame_ByReference.Components.Controls.RadioButtonRuntime;
        DividerInstance3 = this.GetGraphicalUiElementByName("DividerInstance3") as CodeGen_MonoGame_ByReference.Components.Elements.DividerHorizontalRuntime;
        DifficultyLabel = this.GetGraphicalUiElementByName("DifficultyLabel") as CodeGen_MonoGame_ByReference.Components.Controls.LabelRuntime;
        Background1 = this.GetGraphicalUiElementByName("Background1") as global::MonoGameGum.GueDeriving.NineSliceRuntime;
        ComboBoxInstance = this.GetGraphicalUiElementByName("ComboBoxInstance") as CodeGen_MonoGame_ByReference.Components.Controls.ComboBoxRuntime;
        ButtonContainer = this.GetGraphicalUiElementByName("ButtonContainer") as global::MonoGameGum.GueDeriving.ContainerRuntime;
        ButtonConfirmInstance = this.GetGraphicalUiElementByName("ButtonConfirmInstance") as CodeGen_MonoGame_ByReference.Components.Controls.ButtonConfirmRuntime;
        WindowOkButton = this.GetGraphicalUiElementByName("WindowOkButton") as CodeGen_MonoGame_ByReference.Components.Controls.ButtonConfirmRuntime;
        ButtonDenyInstance = this.GetGraphicalUiElementByName("ButtonDenyInstance") as CodeGen_MonoGame_ByReference.Components.Controls.ButtonDenyRuntime;
        ...
        LabelInstance = this.GetGraphicalUiElementByName("LabelInstance") as CodeGen_MonoGame_ByReference.Components.Controls.LabelRuntime;
        TextBoxInstance = this.GetGraphicalUiElementByName("TextBoxInstance") as CodeGen_MonoGame_ByReference.Components.Controls.TextBoxRuntime;
        TextBoxInstance1 = this.GetGraphicalUiElementByName("TextBoxInstance1") as CodeGen_MonoGame_ByReference.Components.Controls.PasswordBoxRuntime;
        MultiLineTextBox = this.GetGraphicalUiElementByName("MultiLineTextBox") as CodeGen_MonoGame_ByReference.Components.Controls.TextBoxRuntime;
        ...
        PercentBarInstance = this.GetGraphicalUiElementByName("PercentBarInstance") as CodeGen_MonoGame_ByReference.Components.Elements.PercentBarRuntime;
        HitpointsBar1 = this.GetGraphicalUiElementByName("HitpointsBar1") as CodeGen_MonoGame_ByReference.Components.Elements.PercentBarRuntime;
        HitpointsBar2 = this.GetGraphicalUiElementByName("HitpointsBar2") as CodeGen_MonoGame_ByReference.Components.Elements.PercentBarRuntime;
        HitpointsBar3 = this.GetGraphicalUiElementByName("HitpointsBar3") as CodeGen_MonoGame_ByReference.Components.Elements.PercentBarRuntime;
        PercentBarInstance1 = this.GetGraphicalUiElementByName("PercentBarInstance1") as CodeGen_MonoGame_ByReference.Components.Elements.PercentBarRuntime;
        PercentBarInstance2 = this.GetGraphicalUiElementByName("PercentBarInstance2") as CodeGen_MonoGame_ByReference.Components.Elements.PercentBarRuntime;
        DividerInstance5 = this.GetGraphicalUiElementByName("DividerInstance5") as CodeGen_MonoGame_ByReference.Components.Elements.DividerHorizontalRuntime;
        ButtonCloseInstance2 = this.GetGraphicalUiElementByName("ButtonCloseInstance2") as CodeGen_MonoGame_ByReference.Components.Controls.ButtonCloseRuntime;
        PercentBarInstance3 = this.GetGraphicalUiElementByName("PercentBarInstance3") as CodeGen_MonoGame_ByReference.Components.Elements.PercentBarRuntime;
        PercentBarInstance4 = this.GetGraphicalUiElementByName("PercentBarInstance4") as CodeGen_MonoGame_ByReference.Components.Elements.PercentBarRuntime;
        PercentBarInstance5 = this.GetGraphicalUiElementByName("PercentBarInstance5") as CodeGen_MonoGame_ByReference.Components.Elements.PercentBarIconRuntime;
        ContainerInstance = this.GetGraphicalUiElementByName("ContainerInstance") as global::MonoGameGum.GueDeriving.ContainerRuntime;
        TreeViewInstance = this.GetGraphicalUiElementByName("TreeViewInstance") as CodeGen_MonoGame_ByReference.Components.Controls.TreeViewRuntime;
