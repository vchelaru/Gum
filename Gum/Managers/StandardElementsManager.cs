    ...
    public void RefreshDefaults()
    {
...

        {
            ...
            stateSave.Variables.Add(new VariableSave { SetsValue = true, Type = "string", Value = "", Name = "SourceShaderFile", IsFile = true, Category = "Rendering",
                DetailText = "A .fx post-process shader applied when this render-target Container is drawn back to the screen. Only used when Is Render Target is checked, and requires a consumer-registered shader resolver to render." });
