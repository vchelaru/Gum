...
namespace GameUiSamples.Components
{
    partial class Hotbar:MonoGameGum.Forms.Controls.FrameworkElement
    {
        ...
        protected override void ReactToVisualChanged()
        {
            ...
            ItemSlotInstance1 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ItemSlot>(this.Visual,"ItemSlotInstance1");
            ItemSlotInstance2 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ItemSlot>(this.Visual,"ItemSlotInstance2");
            ItemSlotInstance3 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ItemSlot>(this.Visual,"ItemSlotInstance3");
            ItemSlotInstance4 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ItemSlot>(this.Visual,"ItemSlotInstance4");
            ItemSlotInstance5 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ItemSlot>(this.Visual,"ItemSlotInstance5");
            ItemSlotInstance6 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ItemSlot>(this.Visual,"ItemSlotInstance6");
