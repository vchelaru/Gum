...
namespace GameUiSamples.Screens
{
    partial class HollowKnightHudScreen:MonoGameGum.Forms.Controls.FrameworkElement
    {
        ...
        protected override void ReactToVisualChanged()
        {
            ...
            HealthItemInstance3 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<HealthItem>(this.Visual,"HealthItemInstance3");
            HealthItemInstance4 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<HealthItem>(this.Visual,"HealthItemInstance4");
            HealthItemInstance5 = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<HealthItem>(this.Visual,"HealthItemInstance5");
            CurrencyInstance = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<Currency>(this.Visual,"CurrencyInstance");
            ActionButtonContainer = this.Visual?.GetGraphicalUiElementByName("ActionButtonContainer") as ContainerRuntime;
            AddManaButton = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ButtonStandard>(this.Visual,"AddManaButton");
            SubtractManaButton = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ButtonStandard>(this.Visual,"SubtractManaButton");
            TakeDamageButton = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ButtonStandard>(this.Visual,"TakeDamageButton");
            RefillHealthButton = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ButtonStandard>(this.Visual,"RefillHealthButton");
            AddMoneyButton = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ButtonStandard>(this.Visual,"AddMoneyButton");
            ExitButton = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<ButtonStandard>(this.Visual,"ExitButton");
            CustomInitialize();
        }
