...
namespace GameUiSamples.Screens
{
    partial class GameTitleScreen:MonoGameGum.Forms.Controls.FrameworkElement
    {
        ...
        protected override void ReactToVisualChanged()
        {
            ...
            Player1Button = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<TitleScreenButton>(this.Visual,"Player1Button");
            Player2Button = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<TitleScreenButton>(this.Visual,"Player2Button");
            OptionsButton = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<TitleScreenButton>(this.Visual,"OptionsButton");
            ExitButton = MonoGameGum.Forms.GraphicalUiElementFormsExtensions.GetFrameworkElementByName<TitleScreenButton>(this.Visual,"ExitButton");
