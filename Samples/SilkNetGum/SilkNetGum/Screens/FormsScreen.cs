...
/// <summary>
/// Mirror of <c>MonoGameGumInCode.Screens.FormsScreen</c>, adapted for the SkiaGum Silk.NET host
/// so the two samples can be opened side by side to compare Forms control rendering between
/// MonoGame and Skia. This screen also exercises real Silk.NET.Input-backed Forms input (mouse
/// click-through, text entry, Tab focus traversal) -- see #3652.
///
/// Section order mirrors MonoGameGumInCode's FormsScreen top to bottom, followed by a Menu
/// section that MonoGameGumInCode's FormsScreen does not currently have (added here to exercise
/// the Menu/MenuItem V3 default visuals, per issue #3652).
/// </summary>
