...
Background.SetProperty("StyleCategoryState", "Bordered");
            ...
            this.Icon.Height = 0f;
            this.Icon.HeightUnits = global::Gum.DataTypes.DimensionUnitType.RelativeToContainer;
            this.Icon.Width = 0f;
            this.Icon.WidthUnits = global::Gum.DataTypes.DimensionUnitType.RelativeToContainer;
