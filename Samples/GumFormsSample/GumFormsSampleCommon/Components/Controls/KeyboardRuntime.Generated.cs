    ...
    public partial class KeyboardRuntime:ContainerRuntime
    {
        ...
        public CursorMoveCategory CursorMoveCategoryState
        {
            set
            {
                ...
                {
                    var category = ((Gum.DataTypes.ElementSave)this.Tag).Categories.FirstOrDefault(item => item.Name == "CursorMoveCategory");
                    var state = category.States.Find(item => item.Name == value.ToString());
                    this.ApplyState(state);
                }
            }
        ...
        {
            Row1Keys = this.GetGraphicalUiElementByName("Row1Keys") as ContainerRuntime;
            AllRows = this.GetGraphicalUiElementByName("AllRows") as ContainerRuntime;
            ...
            Row2Keys = this.GetGraphicalUiElementByName("Row2Keys") as ContainerRuntime;
            Row3Keys = this.GetGraphicalUiElementByName("Row3Keys") as ContainerRuntime;
            Row4Keys = this.GetGraphicalUiElementByName("Row4Keys") as ContainerRuntime;
            Row5Keys = this.GetGraphicalUiElementByName("Row5Keys") as ContainerRuntime;
            ...
            HighlightRectangle = this.GetGraphicalUiElementByName("HighlightRectangle") as RectangleRuntime;
