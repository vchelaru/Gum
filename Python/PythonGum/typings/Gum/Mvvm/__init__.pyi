...
class DependsOnAttribute(typing.Any):
    ParentProperty: typing.Any  # property
    TypeId: typing.Any  # property
    def Equals(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
    def GetHashCode(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
    def Match(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
    def IsDefaultAttribute(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
