...
class AnimationRuntimeExtensions(typing.Any):
    def ToRuntime(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
    def ToRuntime(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
...
class AnimationRuntime(typing.Any):
    ...
    Length: typing.Any  # property
    Keyframes: typing.Any  # property
    def RefreshCumulativeStates(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
    def GetStateToSet(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
    def ApplyAtTimeTo(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
    def ToString(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
    def Equals(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
    def GetHashCode(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
    def GetType(self, *args: typing.Any, **kw: typing.Any) -> typing.Any: ...
...
class KeyframeRuntime(typing.Any):
    CachedCumulativeState: typing.Any  # property
    StateName: typing.Any  # property
    AnimationName: typing.Any  # property
    EventName: typing.Any  # property
    SubAnimation: typing.Any  # property
