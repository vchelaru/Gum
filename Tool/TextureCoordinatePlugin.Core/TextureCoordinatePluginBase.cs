...
/// <summary>
/// The texture-coordinates tab, complete except for its view: a head derives an exported plugin
/// and returns its own <see cref="ITextureCoordinateView"/> from <see cref="CreateView"/>.
/// </summary>
public abstract class TextureCoordinatePluginBase : PluginBase, IRecipient<UiBaseFontSizeChangedMessage>
{
    ...
    /// <summary>Builds the head's view of the tab: toolbar, canvas control, and scroll bars.</summary>
    protected abstract ITextureCoordinateView CreateView();

    protected TextureCoordinatePluginBase(
