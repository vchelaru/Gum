...
public sealed class AnimationsView : Grid
{
    ...
    private Control CreateAnimationsColumn()
    {
        ...
        animations.ContextMenu = ContextMenuFactory.CreateRebuildingMenu(() => ViewModel?.AnimationRightClickItems);
    ...
    private Control CreateKeyframesColumn()
    {
        ...
        keyframes.ContextMenu = ContextMenuFactory.CreateRebuildingMenu(() => ViewModel?.AnimationStateRightClickItems);
