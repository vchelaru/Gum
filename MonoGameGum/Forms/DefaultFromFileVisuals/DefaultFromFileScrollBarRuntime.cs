...
public class DefaultFromFileScrollBarRuntime : InteractiveGue
{
    public DefaultFromFileScrollBarRuntime(bool fullInstantiation = true, bool tryCreateFormsObject = true) :
    base() { }
