Remove-Item -Path "GumCommon/bin" -Recurse -Force -ErrorAction SilentlyContinue
Remove-Item -Path "GumDataTypes/bin" -Recurse -Force -ErrorAction SilentlyContinue
Remove-Item -Path "MonoGameGum/bin" -Recurse -Force -ErrorAction SilentlyContinue
Remove-Item -Path "MonoGameGum/FnaGum/bin" -Recurse -Force -ErrorAction SilentlyContinue
