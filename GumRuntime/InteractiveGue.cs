    ...
    public partial class InteractiveGue : GraphicalUiElement
    {
        ...
        private void RemoveBindingContextRecursively()
        {
            ...
            if (this.Children != null)
            {
                ...
                {
                    if (child is InteractiveGue gue)
                    {
            ...
            else
            {
                foreach (var gue in this.WhatThisContains)
                {
                    ...
                    {
                        interactiveGue.RemoveBindingContextRecursively();
                    }
                }
            }
        }
        ...
        private void HandleBindingContextChangedInternal(object oldBindingContext)
        {
            ...
            else
            {
                ...
                {
                    var interactiveGue = gue as InteractiveGue;

                    if (interactiveGue?.BindingContextBinding != null)
                    {
                        interactiveGue.BindingContextBindingPropertyOwner = EffectiveBindingContext;

                        interactiveGue.UpdateToVmProperty(interactiveGue.BindingContextBinding);
                    }
                }
            }
        ...
        private void TryPushBindingContextChangeToChildren(string vmPropertyName)
        {
            ...
            else
            {
                ...
                {
                    var gue = WhatThisContains[i] as InteractiveGue;
