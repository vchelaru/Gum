namespace Gum.Forms.Input;

/// <summary>
/// Platform-neutral keyboard key enum used by Gum Forms controls.
/// </summary>
/// <remarks>
/// Values and names mirror <c>Microsoft.Xna.Framework.Input.Keys</c> exactly — every key
/// XNA defines, with identical numeric values and identical names. This is a permanent
/// commitment: values will not change after ship, because user <c>KeyCombo</c> bindings
/// may be serialized and changing values would silently reshuffle them.
/// <para/>
/// On XNA-like runtimes (MonoGame / KNI / FNA) and FRB, <c>KeyCombo</c> continues to use
/// <c>Microsoft.Xna.Framework.Input.Keys</c> directly and the values cast cleanly to <see cref="Keys"/>.
/// On non-XNA runtimes (Raylib, Sokol), <c>KeyCombo</c> uses <see cref="Keys"/> and the runtime's
/// <c>Keyboard</c> translates to the native key type internally.
/// </remarks>
public enum Keys
{
    ...
    Help = 47,
    /// <summary>Digit zero key.</summary>
    D0 = 48,
    /// <summary>Digit one key.</summary>
    D1 = 49,
    /// <summary>Digit two key.</summary>
    D2 = 50,
    /// <summary>Digit three key.</summary>
    D3 = 51,
    /// <summary>Digit four key.</summary>
    D4 = 52,
    /// <summary>Digit five key.</summary>
    D5 = 53,
    /// <summary>Digit six key.</summary>
    D6 = 54,
    /// <summary>Digit seven key.</summary>
    D7 = 55,
    /// <summary>Digit eight key.</summary>
    D8 = 56,
    /// <summary>Digit nine key.</summary>
    D9 = 57,
