...
For when to use this strategy vs dynamic generation, see the decision tree on the [Fonts](fonts.md) page. The FontCache is also the only available strategy today for runtimes that don't yet have dynamic generation (Sokol).
