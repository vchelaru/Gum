...
* Skia is not directly supported, but many of the same shapes can be created using Apos.Shapes. For more information see the [Apos.Shapes](../standard-visuals/shapes-apos.shapes.md) page.
