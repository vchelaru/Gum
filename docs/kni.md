...
2.  Download and run the latest KniSdkSetup exe\
    ...
    <figure><img src=".gitbook/assets/image.png" alt=""><figcaption><p>KniSdkSetup in GitHub</p></figcaption></figure>
...
6.  Select one of the project templates, such as **Web browser**\
    ...
    <figure><img src=".gitbook/assets/image (1).png" alt=""><figcaption><p>Web browser project in Kni</p></figcaption></figure>
