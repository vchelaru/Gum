...
1. Your Gum version < 2026
   1. Download the latest `setup_gum_linux.sh` script to your home directory [https://github.com/vchelaru/Gum/blob/main/setup\_gum\_linux.sh](https://github.com/vchelaru/Gum/blob/main/setup_gum_linux.sh)
