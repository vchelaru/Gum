...
{% hint style="info" %}
Variable references can also be re-evaluated at runtime to support theming and dynamic styling. For details, see [Runtime Variable References](../../../code/styling/runtime-variable-references.md).
{% endhint %}
