...
<figure><img src="../../../.gitbook/assets/image (12).png" alt=""><figcaption><p>The first Text is using a custom Hiero font, the second is using a default font</p></figcaption></figure>
