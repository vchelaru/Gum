...
* [Examples](examples/README.md)
  ...
  * [Centering](examples/centering.md)
...
* [Gum Elements](gum-elements/README.md)
  ...
  * [Text](gum-elements/text/README.md)
    ...
    * [Is Bold](gum-elements/text/is-bold.md)
    * [Is Italic](gum-elements/text/is-italic.md)
...
* [Code Tab](code-tab/README.md)
  * [Generation Scope](code-tab/generation-scope.md)
  * [Inheritance Location](code-tab/inheritance-location.md)
  * [Is CodeGen Plugin Enabled](code-tab/is-codegen-plugin-enabled.md)
  * [Show CodeGen Preview](code-tab/show-codegen-preview.md)
* [Menu](menu/README.md)
...
* [Gum Code Reference](gum-code-reference/README.md)
  ...
  * [Camera](gum-code-reference/camera.md)
  ...
  * [GraphicalUiElement](gum-code-reference/graphicaluielement/README.md)
    ...
    * [GetAbsoluteWidth](gum-code-reference/graphicaluielement/getabsolutewidth.md)
    * [GetChildByNameRecursively](gum-code-reference/graphicaluielement/getchildbynamerecursively.md)
    * [RemoveFromManagers](gum-code-reference/graphicaluielement/removefrommanagers.md)
...
* [MonoGame](monogame/README.md)
  ...
  * [Tutorials](monogame/tutorials/README.md)
    * [Gum Project (.gumx) Tutorial](monogame/tutorials/gum-project-.gumx-tutorial/README.md)
      * [Setup](monogame/tutorials/gum-project-.gumx-tutorial/setup.md)
      * [Gum Screens](monogame/tutorials/gum-project-.gumx-tutorial/gum-screens.md)
      * [Gum Forms](monogame/tutorials/gum-project-.gumx-tutorial/gum-forms.md)
      * [Strongly Typed Components Using Code Generation](monogame/tutorials/gum-project-.gumx-tutorial/strongly-typed-components-using-code-generation.md)
      * [Multiple Screens](monogame/tutorials/gum-project-.gumx-tutorial/multiple-screens.md)
  ...
  * [Gum Forms](monogame/gum-forms/README.md)
    ...
    * [Troubleshooting](monogame/gum-forms/troubleshooting.md)
  * [File Loading](monogame/file-loading.md)
  * [Resizing the Game Window](monogame/resizing-the-game-window.md)
