...
/// <summary>
/// Meadow-styled ScrollBar visual. 18 px wide coral thumb on a transparent
/// track, no up/down arrow buttons. <see cref="ShowFrame"/> paints an optional
/// peach-bordered cream frame for free-floating scrollbars.
/// </summary>
public class ScrollBarVisual : BaseScrollBarVisual
{
    private const float ThumbInset = 3f;

    private const float FrameCornerRadius = 16f;
    private const float FrameBorderThickness = 2.5f;
    ...
    /// <summary>
    /// When true, paints a cream fill + 2.5 px peach border around the scroll
    /// bar (CornerRadius=16). Use for free-floating scroll bars that aren't
    /// nested inside a Meadow container. Mirrors Dark Pro's
    ...
    private static RectangleRuntime CreateFrameFill()
    {
        ...
        fill.Name = "MeadowScrollBarFrameFill";
        fill.X = 0;
        fill.Y = 0;
    ...
    private static RectangleRuntime CreateFrameBorder()
    {
        ...
        border.Name = "MeadowScrollBarFrameBorder";
        border.X = 0;
        border.Y = 0;
