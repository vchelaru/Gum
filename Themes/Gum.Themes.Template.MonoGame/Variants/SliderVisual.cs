...
/// <summary>
/// "Rich" variant of the Template Slider. Identical to the flat
/// <see cref="Gum.Themes.Template.SliderVisual"/> except it instantiates the
/// Variants <see cref="SliderThumbVisual"/> (a circle thumb with a soft drop
/// shadow) instead of the flat thumb. Track/fill colors, states, the
/// <c>"ThumbInstance"</c> name, and the ButtonCategory wiring are identical to the
/// flat source.
/// <para>
...
public class SliderVisual : BaseSliderVisual
{
        ...
        : base(fullInstantiation, tryCreateFormsObject: false)
    {
        ...
        // shapes with a fixed height, so they come from TemplateShapes with Height
    ...
    private static RectangleRuntime CreateFillBar()
    {
        ...
        // full-parent shape TemplateShapes builds, so it's constructed directly. Width
