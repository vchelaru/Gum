...
public class ScrollBarVisual : BaseScrollBarVisual
{
        ...
        : base(fullInstantiation, tryCreateFormsObject: false)
    {
        ...
        _frameFill = TemplateShapes.Fill(TemplatePalette.Surface1, FrameCornerRadius, "TemplateScrollBarFrameFill");
        _frameFill.Visible = false;
        AddChild(_frameFill);
        _frameBorder = TemplateShapes.Border(TemplatePalette.Border, FrameCornerRadius, FrameBorderThickness, "TemplateScrollBarFrameBorder");
